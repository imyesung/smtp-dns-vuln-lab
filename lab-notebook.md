...
### Stage 3 ― 하드닝 & 재테스트 (완료 *B4 추후 진행 예정)
| #  | Task                         | Status | Evidence/Notes                     |
|----|-----------------------------|--------|-------------------------------------|
...
3. 백업 메커니즘 작성(원격 백업 필요 시 rsync/scp 추가 활용할 수 있도록 설계) 
...
1. **[A1]** 설정 백업 메커니즘
2. **[A2]** 타임스탬프 기반 로그 백업 함수
3. **[B4]** 스크립트 에러 핸들링 강화

### 중기 실행 계획 `Mid Priorty`
4. **[A3]** Makefile 타깃 세분화
5. **[A4]** SMTP 응답 코드별 카테고리화
6. **[A5]** CVSS 자동 산정
7. **[B1]** `main.cf` diff 리포트
8. **[B5]** Bulma 리포트 템플릿 개선
9. **[B3]** 위협 모델 다이어그램

### 후기 실행 계획 `Low Priorty`
10. **[B2]** SMTP 시퀀스 다이어그램
11. **[B6]** DNS 재귀 질의 설정
